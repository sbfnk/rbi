...
# Settings
settings <- bi::settings(mode = "sample", configfile = "posterior.conf", args = "--samplingmethod smc2")
...
multilauncher(settings, args=" --end-time 50 -D 256 --nparticles 1024", nruns = nruns, 
