...
#' It also provides various utility functions to browse the output from
#' \code{libbi},
...
#' \item A \code{\link{bi_model}} class that can be used to load and manipulate
#' \code{libbi} models
#' \item Functions to manipulate the results of the \code{libbi} command, which
#' are stored in NetCDF files. Those functions allow to extract variables of
#' interest.
#' }
#'
#'
...
#' @author Pierre E. Jacob \email{pierre.jacob.work@@gmail.com}, Anthony Lee
#'   \email{awllee@gmail.com}, Lawrence Murray \email{lawrence.murray@csiro.au},
#'   Sebastian Funk \email{sebastian.funk@@lshtm.ac.uk}
