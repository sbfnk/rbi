...
Other ways of implementing a (deterministic or stochastic) SIR model can be found in the [collection of SIR models for LibBi](http://sbfnk.github.io/rbi/idd_models.html), where you also find how to load them into a `bi_model` object, e.g. `SIRmodel`. Feel free to run the commands below with different versions of the model.
...
```{r, eval = NOT_CRAN}
set.seed(1001912)
SIRdata <- generate_dataset(SIRmodel, end_time=16*7, noutputs=16)
```
