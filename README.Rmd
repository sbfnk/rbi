---
title: Bayesian inference for state-space models with R <a href="https://sbfnk.github.io/rbi/"><img src="man/figures/logo.png" align="right" height="139" alt="rbi website" /></a>
output: github_document
---

<!-- badges: start -->
[![CRAN version](https://www.r-pkg.org/badges/version-ago/rbi)](https://cran.r-project.org/package=rbi)
![GitHub R package version](https://img.shields.io/github/r-package/v/sbfnk/rbi)
...
[rbi](https://github.com/sbfnk/rbi) is an `R` interface to [libbi](https://libbi.org), a library for Bayesian inference.
