...
<!-- badges: start -->
[![CRAN version](https://www.r-pkg.org/badges/version-ago/rbi)](https://cran.r-project.org/package=rbi)
![GitHub R package version](https://img.shields.io/github/r-package/v/epiforecasts/rbi)
...
![GitHub contributors](https://img.shields.io/github/contributors/epiforecasts/rbi)
 [![License: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0)
<!-- badges: end -->

[rbi](https://github.com/epiforecasts/rbi) is an `R` interface to [libbi](https://libbi.org), a library for Bayesian inference.
...
For higher-level methods to interact with [LibBi](https://github.com/lawmurray/LibBi), have a look at [rbi.helpers](https://github.com/epiforecasts/rbi.helpers).
